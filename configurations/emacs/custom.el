(custom-set-variables
 ...
 '(terminal-here-terminal-command-table
   '((urxvt "urxvt")
     ...
     (alacritty "alacritty")
     (xst "xst")
     (st . terminal-here--find-and-run-st)
     (konsole "konsole")
     (qterminal "qterminal")
     (xterm "xterm")
     (sakura "sakura")
