...
#+end_src
** lm-tui
#+begin_src emacs-lisp :tangle "lm-modules/lm-tui.el"
  ;; -*- lexical-binding: t -*-
  (unless (display-graphic-p)
    (cond
     ;; ON LINUX ...
     ((string= system-type "gnu/linux")
      (cond
       ;; HANDLE Wayland wl-copy has clipboard provider
       ...
       ;; HANDLE X11 xcopy has clipboard provider
       ((string= (getenv "XDG_SESSION_TYPE") "x")
        ;; TODO
        )))
     ;; ON WINDOWS ...
