...
#+begin_src shell
  ./configure --prefix=/usr/local --with-pgtk --disable-gc-mark-trace --with-native-compilation=aot --without-compress-install --with-tree-sitter=ifavailable --without-gsettings --without-gconf
#+end_src
