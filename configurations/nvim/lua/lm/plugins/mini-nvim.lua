local function insert_functionalities()
  LM.Mini = {

    activate_animate = function()
      require('mini.animate').setup()
    end,

    activate_completion = function()
      ...
      LM.completion.complete = function()
        MiniCompletion.complete_twostage()
      end
    end,

    activate_files = function()
    ...
    activate_notify = function ()
      require('mini.notify').setup()
    end,

    activate_pick = function()
